...
import pl.wsiz.schedule.adapters.GroupAdapter;
...
public class Page_groups extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GroupAdapter adapter = new GroupAdapter(this, spf.getInt(Prefs.GLOBAL_DEEP, 0));
