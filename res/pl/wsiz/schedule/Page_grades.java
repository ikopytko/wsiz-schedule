...
import pl.wsiz.schedule.adapters.GradesAdapter;
...
public class Page_grades extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GradesAdapter adapter = new GradesAdapter(this, spf.getInt(Prefs.GLOBAL_DEEP, 0));
