...
public class Page_menu extends SherlockActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout btn_to_schedule = (LinearLayout) findViewById(R.id.btn_to_schedule);
		LinearLayout btn_to_grades = (LinearLayout) findViewById(R.id.btn_to_grades);
		LinearLayout btn_to_plan = (LinearLayout) findViewById(R.id.btn_to_plan);
		LinearLayout btn_to_groups = (LinearLayout) findViewById(R.id.btn_to_groups);
		LinearLayout btn_to_bus = (LinearLayout) findViewById(R.id.btn_to_bus);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.item_refresh:
			if (spf.getBoolean(Prefs.APP_MODE, false)) // check availible login/password
			{
				...
				try {
					...
					if (sp.getBoolean(Prefs.UPDATE_PLAN, true)) {
						//db.execSQL("DROP TABLE IF EXISTS " + "academic_plan");
						//db.execSQL("VACUUM");
	...
	class SetConnect extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pd.setTitle("Working...");
			pd.setMessage("request to server");
		...
		protected boolean firstRequest() // return true in case success login
		{
			...
			try {
				...
				postValPr.add(new BasicNameValuePair(POST_LOGIN, spf.getString(Prefs.USER_LOGIN, "")));
